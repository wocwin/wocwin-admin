...
// 相关列表
listTypeInfo:{sexList:[{key:"女",value:1},{key:"男",value:0}],accountTypeList:{0:"手机用户",1:"论坛用户",2:"平台用户"},statusList:[{key:"启用",value:1},{key:"停用",value:0}]}}}});return(e,s)=>{const r=t("t-module-form"),m=t("t-layout-page-item"),c=t("t-layout-page");return l(),a(c,{class:"t_module_form_demo"},{default:i((()=>[o(m,{isNoMargin:""},{default:i((()=>[o(r,{title:"表单对齐方式",ref_key:"sourceForm",ref:u,formOpts:n,submit:p},null,8,["formOpts"])])),_:1})])),_:1})}}}),[["__file","labelPosition.vue"]]);export{p as default};
