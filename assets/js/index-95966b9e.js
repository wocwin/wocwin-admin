...
// 相关列表
listTypeInfo:{hobbyList:[{label:"吉他",value:"0"},{label:"看书",value:"1"},{label:"美剧",value:"2"},{label:"旅游",value:"3"},{label:"音乐",value:"4"}],sexList:[{key:"女",value:1},{key:"男",value:0}],statusList:[{key:"启用",value:1},{key:"停用",value:0}]}}),n=(e,t)=>{e};return(e,i)=>{const o=t("t-form"),v=t("t-layout-page-item"),c=t("t-layout-page");return l(),r(c,null,{default:s((()=>[a(v,null,{default:s((()=>[a(o,{ref_key:"TFormDemo",ref:p,modelValue:u(m).ref,"onUpdate:modelValue":i[0]||(i[0]=e=>u(m).ref=e),formOpts:u(m),widthSize:3,onHandleEvent:n},null,8,["modelValue","formOpts"])])),_:1})])),_:1})}}}),[["__file","index.vue"]]);export{m as default};
