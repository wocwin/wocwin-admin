import{s as e}from"./@intlify_shared@9.2.2-eb5ba5c2.js";import{b as a}from"./@intlify_core-base@9.2.2-0528b302.js";import{r as t}from"./vue@3.2.47-c2cc0741.js";var l={};
/*!
  * vue-i18n v9.2.2
...
__composer:a,
// t
t(...e){const[t,l,r]=e,s={};let o=null,i=null;if(!n.isString(t))throw b(p.INVALID_ARGUMENT);const c=t;return n.isString(l)?s.locale=l:n.isArray(l)?o=l:n.isPlainObject(l)&&(i=l),n.isArray(r)?o=r:n.isPlainObject(r)&&(i=r),Reflect.apply(a.t,a,[c,o||i||{},s])},rt:(...e)=>Reflect.apply(a.rt,a,[...e]),
// tc
tc(...e){const[t,l,r]=e,s={plural:1};let o=null,i=null;if(!n.isString(t))throw b(p.INVALID_ARGUMENT);const c=t;return n.isString(l)?s.locale=l:n.isNumber(l)?s.plural=l:n.isArray(l)?o=l:n.isPlainObject(l)&&(i=l),n.isString(r)?s.locale=r:n.isArray(r)?o=r:n.isPlainObject(r)&&(i=r),Reflect.apply(a.t,a,[c,o||i||{},s])},
// te
te:(e,t)=>a.te(e,t),
// tm
tm:e=>a.tm(e),
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
t[O](...e)))}};function G(e){const a=a=>{const{instance:t,modifiers:l,value:r}=a;if(!t||!t.$)throw b(p.UNEXPECTED_ERROR);const s=function(e,a){const t=e;if("composition"===e.mode)return t.__getInstance(a)||e.global;{const l=t.__getInstance(a);return null!=l?l.__composer:e.global.__composer}}(e,t.$);l.preserve&&n.warn(_(u.NOT_SUPPORTED_PRESERVE));const o=x(r);return[Reflect.apply(s.t,s,[...Y(o)]),s]};return{created:(t,l)=>{const[r,o]=a(l);n.inBrowser&&e.global===o&&(t.__i18nWatcher=s.watch(o.locale,(()=>{l.instance&&l.instance.$forceUpdate()}))),t.__composer=o,t.textContent=r},unmounted:e=>{n.inBrowser&&e.__i18nWatcher&&(e.__i18nWatcher(),e.__i18nWatcher=void 0,delete e.__i18nWatcher),e.__composer&&(e.__composer=void 0,delete e.__composer)},beforeUpdate:(e,{value:a})=>{if(e.__composer){const t=e.__composer,l=x(a);e.textContent=Reflect.apply(t.t,t,[...Y(l)])}},getSSRProps:e=>{const[t]=a(e);return{textContent:t}}}}function x(e){if(n.isString(e))return{path:e};if(n.isPlainObject(e)){if(!("path"in e))throw b(p.REQUIRED_VALUE,"path");return e}throw b(p.INVALID_VALUE)}function Y(e){const{path:a,locale:t,args:l,choice:r,plural:s}=e,o={},i=l||{};return n.isString(t)&&(o.locale=t),n.isNumber(r)&&(o.plural=r),n.isNumber(s)&&(o.plural=s),[a,i,o]}function X(e,a){e.locale=a.locale||e.locale,e.fallbackLocale=a.fallbackLocale||e.fallbackLocale,e.missing=a.missing||e.missing,e.silentTranslationWarn=a.silentTranslationWarn||e.silentFallbackWarn,e.silentFallbackWarn=a.silentFallbackWarn||e.silentFallbackWarn,e.formatFallbackMessages=a.formatFallbackMessages||e.formatFallbackMessages,e.postTranslation=a.postTranslation||e.postTranslation,e.warnHtmlInMessage=a.warnHtmlInMessage||e.warnHtmlInMessage,e.escapeParameterHtml=a.escapeParameterHtml||e.escapeParameterHtml,e.sync=a.sync||e.sync,e.__composer[N](a.pluralizationRules||e.pluralizationRules);const t=P(e.locale,{messages:a.messages,__i18n:a.__i18n});return Object.keys(t).forEach((a=>e.mergeLocaleMessage(a,t[a]))),a.datetimeFormats&&Object.keys(a.datetimeFormats).forEach((t=>e.mergeDateTimeFormat(t,a.datetimeFormats[t]))),a.numberFormats&&Object.keys(a.numberFormats).forEach((t=>e.mergeNumberFormat(t,a.numberFormats[t]))),e}const K=n.makeSymbol("global-vue-i18n");function z(e={}){const a=s.getCurrentInstance();if(null==a)throw b(p.MUST_BE_CALL_SETUP_TOP);if(!a.isCE&&null!=a.appContext.app&&!a.appContext.app.__VUE_I18N_SYMBOL__)throw b(p.NOT_INSLALLED);const t=function(e){{const a=s.inject(e.isCE?K:e.appContext.app.__VUE_I18N_SYMBOL__);if(!a)throw b(e.isCE?p.NOT_INSLALLED_WITH_PROVIDE:p.UNEXPECTED_ERROR);return a}}(a),l=function(e){return"composition"===e.mode?e.global:e.global.__composer}(t),o=h(a),i=function(e,a){return n.isEmptyObject(e)?"__i18n"in a?"local":"global":e.useScope?e.useScope:"local"}(e,o);if("legacy"===t.mode&&!e.__useComponent){if(!t.allowComposition)throw b(p.NOT_AVAILABLE_IN_LEGACY_MODE);return function(e,a,t,l={}){const o="local"===a,i=s.shallowRef(null);if(o&&e.proxy&&!e.proxy.$options.i18n&&!e.proxy.$options.__i18n)throw b(p.MUST_DEFINE_I18N_OPTION_IN_ALLOW_COMPOSITION);const c=!n.isBoolean(l.inheritLocale)||l.inheritLocale,u=s.ref(
// prettier-ignore
o&&c?t.locale.value:n.isString(l.locale)?l.locale:r.DEFAULT_LOCALE),m=s.ref(
// prettier-ignore
o&&c?t.fallbackLocale.value:n.isString(l.fallbackLocale)||n.isArray(l.fallbackLocale)||n.isPlainObject(l.fallbackLocale)||!1===l.fallbackLocale?l.fallbackLocale:u.value),_=s.ref(P(u.value,l)),g=s.ref(n.isPlainObject(l.datetimeFormats)?l.datetimeFormats:{[u.value]:{}}),f=s.ref(n.isPlainObject(l.numberFormats)?l.numberFormats:{[u.value]:{}}),v=o?t.missingWarn:!n.isBoolean(l.missingWarn)&&!n.isRegExp(l.missingWarn)||l.missingWarn,E=o?t.fallbackWarn:!n.isBoolean(l.fallbackWarn)&&!n.isRegExp(l.fallbackWarn)||l.fallbackWarn,O=o?t.fallbackRoot:!n.isBoolean(l.fallbackRoot)||l.fallbackRoot,T=!!l.fallbackFormat,d=n.isFunction(l.missing)?l.missing:null,L=n.isFunction(l.postTranslation)?l.postTranslation:null,N=o?t.warnHtmlMessage:!n.isBoolean(l.warnHtmlMessage)||l.warnHtmlMessage,R=!!l.escapeParameter,I=o?t.modifiers:n.isPlainObject(l.modifiers)?l.modifiers:{},k=l.pluralRules||o&&t.pluralRules;function F(){return[u.value,m.value,_.value,g.value,f.value]}const h=s.computed({get:()=>i.value?i.value.locale.value:u.value,set:e=>{i.value&&(i.value.locale.value=e),u.value=e}}),y=s.computed({get:()=>i.value?i.value.fallbackLocale.value:m.value,set:e=>{i.value&&(i.value.fallbackLocale.value=e),m.value=e}}),A=s.computed((()=>i.value?i.value.messages.value:_.value)),S=s.computed((()=>g.value)),M=s.computed((()=>f.value));function C(){return i.value?i.value.getPostTranslationHandler():L}function D(e){i.value&&i.value.setPostTranslationHandler(e)}function U(){return i.value?i.value.getMissingHandler():d}function W(e){i.value&&i.value.setMissingHandler(e)}function w(e){return F(),e()}function j(...e){return i.value?w((()=>Reflect.apply(i.value.t,null,[...e]))):w((()=>""))}function V(...e){return i.value?Reflect.apply(i.value.rt,null,[...e]):""}function H(...e){return i.value?w((()=>Reflect.apply(i.value.d,null,[...e]))):w((()=>""))}function B(...e){return i.value?w((()=>Reflect.apply(i.value.n,null,[...e]))):w((()=>""))}function $(e){return i.value?i.value.tm(e):{}}function G(e,a){return!!i.value&&i.value.te(e,a)}function x(e){return i.value?i.value.getLocaleMessage(e):{}}function Y(e,a){i.value&&(i.value.setLocaleMessage(e,a),_.value[e]=a)}function X(e,a){i.value&&i.value.mergeLocaleMessage(e,a)}function K(e){return i.value?i.value.getDateTimeFormat(e):{}}function z(e,a){i.value&&(i.value.setDateTimeFormat(e,a),g.value[e]=a)}function q(e,a){i.value&&i.value.mergeDateTimeFormat(e,a)}function J(e){return i.value?i.value.getNumberFormat(e):{}}function Q(e,a){i.value&&(i.value.setNumberFormat(e,a),f.value[e]=a)}function Z(e,a){i.value&&i.value.mergeNumberFormat(e,a)}const ee={get id(){return i.value?i.value.id:-1},locale:h,fallbackLocale:y,messages:A,datetimeFormats:S,numberFormats:M,get inheritLocale(){return i.value?i.value.inheritLocale:c},set inheritLocale(e){i.value&&(i.value.inheritLocale=e)},get availableLocales(){return i.value?i.value.availableLocales:Object.keys(_.value)},get modifiers(){return i.value?i.value.modifiers:I},get pluralRules(){return i.value?i.value.pluralRules:k},get isGlobal(){return!!i.value&&i.value.isGlobal},get missingWarn(){return i.value?i.value.missingWarn:v},set missingWarn(e){i.value&&(i.value.missingWarn=e)},get fallbackWarn(){return i.value?i.value.fallbackWarn:E},set fallbackWarn(e){i.value&&(i.value.missingWarn=e)},get fallbackRoot(){return i.value?i.value.fallbackRoot:O},set fallbackRoot(e){i.value&&(i.value.fallbackRoot=e)},get fallbackFormat(){return i.value?i.value.fallbackFormat:T},set fallbackFormat(e){i.value&&(i.value.fallbackFormat=e)},get warnHtmlMessage(){return i.value?i.value.warnHtmlMessage:N},set warnHtmlMessage(e){i.value&&(i.value.warnHtmlMessage=e)},get escapeParameter(){return i.value?i.value.escapeParameter:R},set escapeParameter(e){i.value&&(i.value.escapeParameter=e)},t:j,getPostTranslationHandler:C,setPostTranslationHandler:D,getMissingHandler:U,setMissingHandler:W,rt:V,d:H,n:B,tm:$,te:G,getLocaleMessage:x,setLocaleMessage:Y,mergeLocaleMessage:X,getDateTimeFormat:K,setDateTimeFormat:z,mergeDateTimeFormat:q,getNumberFormat:J,setNumberFormat:Q,mergeNumberFormat:Z};function ae(e){e.locale.value=u.value,e.fallbackLocale.value=m.value,Object.keys(_.value).forEach((a=>{e.mergeLocaleMessage(a,_.value[a])})),Object.keys(g.value).forEach((a=>{e.mergeDateTimeFormat(a,g.value[a])})),Object.keys(f.value).forEach((a=>{e.mergeNumberFormat(a,f.value[a])})),e.escapeParameter=R,e.fallbackFormat=T,e.fallbackRoot=O,e.fallbackWarn=E,e.missingWarn=v,e.warnHtmlMessage=N}return s.onBeforeMount((()=>{if(null==e.proxy||null==e.proxy.$i18n)throw b(p.NOT_AVAILABLE_COMPOSITION_IN_LEGACY);const t=i.value=e.proxy.$i18n.__composer;"global"===a?(u.value=t.locale.value,m.value=t.fallbackLocale.value,_.value=t.messages.value,g.value=t.datetimeFormats.value,f.value=t.numberFormats.value):o&&ae(t)})),ee}(a,i,l,e)}if("global"===i)return y(l,e,o),l;if("parent"===i){let r=function(e,a,t=!1){let l=null;const n=a.root;let r=a.parent;for(;null!=r;){const a=e;if("composition"===e.mode)l=a.__getInstance(r);else{const e=a.__getInstance(r);null!=e&&(l=e.__composer,t&&l&&!l[R]&&(l=null))}if(null!=l)break;if(n===r)break;r=r.parent}return l}(t,a,e.__useComponent);return null==r&&(n.warn(_(u.NOT_FOUND_PARENT_SCOPE)),r=l),r}const c=t;let m=c.__getInstance(a);if(null==m){const t=n.assign({},e);"__i18n"in o&&(t.__i18n=o.__i18n),l&&(t.__root=l),m=U(t),function(e,a,t){s.onMounted((()=>{}),a),s.onUnmounted((()=>{e.__deleteInstance(a)}),a)}(c,a),c.__setInstance(a,m)}return m}const q=["locale","fallbackLocale","availableLocales"],J=["t","rt","d","n","tm"];r.registerMessageCompiler(r.compileToFunction),r.registerMessageResolver(r.resolveValue),r.registerLocaleFallbacker(r.fallbackWithLocaleChain);{const e=n.getGlobalThis();e.__INTLIFY__=!0,r.setDevToolsHook(e.__INTLIFY_DEVTOOLS_GLOBAL_HOOK__)}l.DatetimeFormat=$,l.I18nInjectionKey=K,l.NumberFormat=B,l.Translation=V,l.VERSION=o,l.castToVueI18n=e=>{if(!("__VUE_I18N_BRIDGE__"in e))throw b(p.NOT_COMPATIBLE_LEGACY_VUE_I18N);return e};var Q=l.createI18n=function(e={},a){const t=!n.isBoolean(e.legacy)||e.legacy,l=!n.isBoolean(e.globalInjection)||e.globalInjection,r=!t||!!e.allowComposition,o=new Map,[i,c]=function(e,a,t){const l=s.effectScope();{const t=a?l.run((()=>W(e))):l.run((()=>U(e)));if(null==t)throw b(p.UNEXPECTED_ERROR);return[l,t]}}(e,t),m=n.makeSymbol("vue-i18n");{const e={
// mode
get mode(){return t?"legacy":"composition"},
// allowComposition
get allowComposition(){return r},
// install plugin
async install(a,...r){a.__VUE_I18N_SYMBOL__=m,a.provide(a.__VUE_I18N_SYMBOL__,e),!t&&l&&function(e,a){const t=Object.create(null);q.forEach((e=>{const l=Object.getOwnPropertyDescriptor(a,e);if(!l)throw b(p.UNEXPECTED_ERROR);const n=s.isRef(l.value)?{get:()=>l.value.value,
// eslint-disable-next-line @typescript-eslint/no-explicit-any
set(e){l.value.value=e}}:{get:()=>l.get&&l.get()};Object.defineProperty(t,e,n)})),e.config.globalProperties.$i18n=t,J.forEach((t=>{const l=Object.getOwnPropertyDescriptor(a,t);if(!l||!l.value)throw b(p.UNEXPECTED_ERROR);Object.defineProperty(e.config.globalProperties,`$${t}`,l)}))}(a,e.global),function(e,a,...t){const l=n.isPlainObject(t[0])?t[0]:{},r=!!l.useI18nComponentName,s=!n.isBoolean(l.globalInstall)||l.globalInstall;s&&r&&n.warn(_(u.COMPONENT_NAME_LEGACY_COMPATIBLE,{name:V.name})),s&&(e.component(r?"i18n":V.name,V),e.component(B.name,B),e.component($.name,$)),e.directive("t",G(a))}(a,e,...r),t&&a.mixin(function(e,a,t){return{beforeCreate(){const l=s.getCurrentInstance();if(!l)throw b(p.UNEXPECTED_ERROR);const n=this.$options;if(n.i18n){const t=n.i18n;n.__i18n&&(t.__i18n=n.__i18n),t.__root=a,this===this.$root?this.$i18n=X(e,t):(t.__injectWithOption=!0,this.$i18n=W(t))}else n.__i18n?this===this.$root?this.$i18n=X(e,n):this.$i18n=W({__i18n:n.__i18n,__injectWithOption:!0,__root:a}):this.$i18n=e;n.__i18nGlobal&&y(a,n,n),e.__onComponentInstanceCreated(this.$i18n),t.__setInstance(l,this.$i18n),this.$t=(...e)=>this.$i18n.t(...e),this.$rt=(...e)=>this.$i18n.rt(...e),this.$tc=(...e)=>this.$i18n.tc(...e),this.$te=(e,a)=>this.$i18n.te(e,a),this.$d=(...e)=>this.$i18n.d(...e),this.$n=(...e)=>this.$i18n.n(...e),this.$tm=e=>this.$i18n.tm(e)},mounted(){},unmounted(){const e=s.getCurrentInstance();if(!e)throw b(p.UNEXPECTED_ERROR);delete this.$t,delete this.$rt,delete this.$tc,delete this.$te,delete this.$d,delete this.$n,delete this.$tm,t.__deleteInstance(e),delete this.$i18n}}}(c,c.__composer,e));const o=a.unmount;a.unmount=()=>{e.dispose(),o()}},
// global accessor
