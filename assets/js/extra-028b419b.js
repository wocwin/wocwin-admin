...
// 相关列表
listTypeInfo:{sexList:[{key:"女",value:1},{key:"男",value:0}],accountTypeList:{0:"手机用户",1:"论坛用户",2:"平台用户"},statusList:[{key:"启用",value:1},{key:"停用",value:0}]}}}});return(e,r)=>{const u=a("el-button"),c=a("t-module-form"),d=a("t-layout-page-item"),v=a("t-layout-page");return i(),o(v,{class:"t_module_form_demo"},{default:s((()=>[t(d,{isNoMargin:""},{default:s((()=>[t(c,{title:"Title右侧插槽使用",ref_key:"sourceForm",ref:p,formOpts:m,submit:n},{extra:s((()=>[t(u,{type:"primary"},{default:s((()=>[l("主要按钮")])),_:1}),t(u,{type:"success"},{default:s((()=>[l("成功按钮")])),_:1}),t(u,{type:"danger"},{default:s((()=>[l("信息按钮")])),_:1})])),_:1},8,["formOpts"])])),_:1})])),_:1})}}}),[["__file","extra.vue"]]);export{n as default};
