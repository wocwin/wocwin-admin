import{e,_ as l,o as a,P as t,Q as u,c as n}from"./@vue_runtime-core@3.2.47-c6dbaf88.js";import{r as o,j as p}from"./@vue_reactivity@3.2.47-57d9983b.js";import"./@vue_shared@3.2.47-177e1703.js";const i=e({__name:"index",setup(e){const i=o(null),r=e=>{},s=p({goodsInformation:{title:"货品信息",name:"goodsInformation",ref:null,opts:{formData:{id:`${Math.floor(10*Math.random()+1)}`,
// *唯一ID
account:null,
// *用户账号
password:null,
...
// 相关列表
listTypeInfo:{sexList:[{key:"女",value:1},{key:"男",value:0}],accountTypeList:{0:"手机用户",1:"论坛用户",2:"平台用户"},statusList:[{key:"启用",value:1},{key:"停用",value:0}]}}}});return(e,o)=>{const p=l("t-module-form"),c=l("t-layout-page-item"),m=l("t-layout-page");return a(),t(m,{class:"t_module_form_demo"},{default:u((()=>[n(c,{isNoMargin:""},{default:u((()=>[n(p,{title:"基本使用",subTitle:"基本使用副标题",ref_key:"sourceForm",ref:i,titleBold:"",formOpts:s,submit:r},null,8,["formOpts"])])),_:1})])),_:1})}}});export{i as default};
