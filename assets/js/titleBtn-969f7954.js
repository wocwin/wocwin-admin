...
// 相关列表
listTypeInfo:{sexList:[{key:"女",value:1},{key:"男",value:0}],accountTypeList:{0:"手机用户",1:"论坛用户",2:"平台用户"},statusList:[{key:"启用",value:1},{key:"停用",value:0}]}}}});return(e,r)=>{const u=t("el-button"),d=t("t-table"),v=t("t-module-form"),b=t("t-layout-page-item"),y=t("t-layout-page");return l(),a(y,{class:"t_module_form_demo"},{default:s((()=>[i(b,{isNoMargin:""},{default:s((()=>[i(v,{title:"模块Title右侧插槽使用",ref_key:"sourceForm",ref:p,formOpts:c,submit:n},{extra:s((()=>[i(u,{type:"primary"},{default:s((()=>[o("主要按钮")])),_:1}),i(u,{type:"success"},{default:s((()=>[o("成功按钮")])),_:1}),i(u,{type:"danger"},{default:s((()=>[o("信息按钮")])),_:1})])),lineMessage:s((()=>[i(d,{title:"模块插槽使用",table:m,columns:m.columns,isCopy:""},null,8,["table","columns"])])),material:s((()=>[i(u,{size:"small",type:"primary"},{default:s((()=>[o("批量通过")])),_:1}),i(u,{size:"small",type:"danger"},{default:s((()=>[o("批量驳回")])),_:1}),i(u,{size:"small"},{default:s((()=>[o("导出")])),_:1})])),_:1},8,["formOpts"])])),_:1})])),_:1})}}}),[["__file","titleBtn.vue"]]);export{n as default};
