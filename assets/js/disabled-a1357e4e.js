...
// 相关列表
listTypeInfo:{sexList:[{key:"女",value:1},{key:"男",value:0}],accountTypeList:{0:"手机用户",1:"论坛用户",2:"平台用户"},statusList:[{key:"启用",value:1},{key:"停用",value:0}]}}}});return(e,l)=>{const r=a("t-module-form"),u=a("t-layout-page-item"),c=a("t-layout-page");return i(),o(c,{class:"t_module_form_demo"},{default:s((()=>[t(u,{isNoMargin:""},{default:s((()=>[t(r,{title:"模块表单组件运用",subTitle:"模块表单222",ref_key:"sourceForm",ref:p,formOpts:m,submit:n},null,8,["formOpts"])])),_:1})])),_:1})}}}),[["__file","disabled.vue"]]);export{n as default};
