...
// 相关列表
listTypeInfo:{sexList:[{key:"女",value:1},{key:"男",value:0}],accountTypeList:{0:"手机用户",1:"论坛用户",2:"平台用户"},statusList:[{key:"启用",value:1},{key:"停用",value:0}]}}}});return(e,r)=>{const u=a("el-button"),c=a("t-module-form"),v=a("t-layout-page-item"),d=a("t-layout-page");return i(),s(d,{class:"t_module_form_demo"},{default:o((()=>[t(v,{isNoMargin:""},{default:o((()=>[t(c,{title:"Title右侧插槽使用",ref_key:"sourceForm",ref:p,formOpts:m,submit:n},{extra:o((()=>[t(u,{type:"primary"},{default:o((()=>[l("主要按钮")])),_:1}),t(u,{type:"success"},{default:o((()=>[l("成功按钮")])),_:1}),t(u,{type:"danger"},{default:o((()=>[l("信息按钮")])),_:1})])),_:1},8,["formOpts"])])),_:1})])),_:1})}}}),[["__file","extra.vue"]]);export{n as default};
