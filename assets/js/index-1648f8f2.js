...
// 相关列表
listTypeInfo:{hobbyList:[{label:"吉他",value:"0"},{label:"看书",value:"1"},{label:"美剧",value:"2"},{label:"旅游",value:"3"},{label:"音乐",value:"4"}],sexList:[{key:"女",value:1},{key:"男",value:0}],statusList:[{key:"启用",value:1},{key:"停用",value:0}]}});return(e,r)=>{const u=t("el-radio-button"),v=t("el-radio-group"),c=t("t-form"),_=t("t-layout-page-item"),d=t("t-layout-page");return l(),a(d,null,{default:s((()=>[i(_,null,{default:s((()=>[i(v,{modelValue:p.value,"onUpdate:modelValue":r[0]||(r[0]=e=>p.value=e),size:"small",style:{"margin-bottom":"15px"}},{default:s((()=>[i(u,{label:1},{default:s((()=>[o("一行展示")])),_:1}),i(u,{label:2},{default:s((()=>[o("一行展示2项")])),_:1}),i(u,{label:3},{default:s((()=>[o("一行展示3项")])),_:1}),i(u,{label:4},{default:s((()=>[o("一行展示4项")])),_:1})])),_:1},8,["modelValue"]),i(c,{ref_key:"TFormDemo",ref:n,modelValue:m.ref,"onUpdate:modelValue":r[1]||(r[1]=e=>m.ref=e),formOpts:m,widthSize:p.value},null,8,["modelValue","formOpts","widthSize"])])),_:1})])),_:1})}}}),[["__file","index.vue"]]);export{n as default};
