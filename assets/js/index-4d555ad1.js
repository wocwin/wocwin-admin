...
// 相关列表
listTypeInfo:{hobbyList:[{label:"吉他",value:"0"},{label:"看书",value:"1"},{label:"美剧",value:"2"},{label:"旅游",value:"3"},{label:"音乐",value:"4"}],sexList:[{key:"女",value:1},{key:"男",value:0}],statusList:[{key:"启用",value:1},{key:"停用",value:0}]}});return(e,r)=>{const u=t("el-radio-button"),v=t("el-radio-group"),d=t("t-form"),c=t("t-layout-page-item"),_=t("t-layout-page");return l(),a(_,null,{default:s((()=>[o(c,null,{default:s((()=>[o(v,{modelValue:p(m).labelPosition,"onUpdate:modelValue":r[0]||(r[0]=e=>p(m).labelPosition=e),size:"small",style:{"margin-bottom":"15px"}},{default:s((()=>[o(u,{value:"left"},{default:s((()=>[i("左对齐")])),_:1}),o(u,{value:"right"},{default:s((()=>[i("右对齐")])),_:1}),o(u,{value:"top"},{default:s((()=>[i("顶部对齐")])),_:1})])),_:1},8,["modelValue"]),o(d,{ref_key:"TFormDemo",ref:n,modelValue:p(m).ref,"onUpdate:modelValue":r[1]||(r[1]=e=>p(m).ref=e),formOpts:p(m),widthSize:1},null,8,["modelValue","formOpts"])])),_:1})])),_:1})}}}),[["__file","index.vue"]]);export{m as default};
