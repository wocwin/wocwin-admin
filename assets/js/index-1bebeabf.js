...
// 固定列表右边（left则固定在左边）
align:"left",width:80,label:"操作"}}}),g=s((()=>({systemName:{label:"业务系统",comp:"el-input"},title:{label:"业务模块",comp:"el-input"},operName:{label:"操作人员",comp:"el-input"},businessType:{label:"操作类型",comp:"t-select",isSelfCom:!0,bind:{optionSource:y.listTypeInfo.businessTypeList}},status:{label:"状态",comp:"t-select",isSelfCom:!0,bind:{optionSource:y.listTypeInfo.statusList}},date:{label:"操作时间",comp:"t-date-picker",span:2,bind:{type:"datetimerange"}}}))),f=s((()=>{const{title:e,systemName:t,operName:a,businessType:l,status:s,date:i}=m(y.queryData);return{title:e.value,systemName:t.value,operName:a.value,businessType:l.value,status:s.value,beginTime:i.value&&i.value[0]?i.value[0]:null,endTime:i.value&&i.value[1]?i.value[1]:null,pageNum:y.table.currentPage,pageSize:y.table.pageSize}})),h=e=>{y.queryData=e,T()},v=e=>{y.ids=e.map((e=>e.operId))};i((()=>{T()}));const T=async()=>{const e=await u.$api.logList(f.value);e.success&&(y.table.data=e.data.rows,y.table.total=e.data.total)},k=e=>{y.table.pageSize=e,T()},S=e=>{y.table.currentPage=e,T()};return(e,t)=>{const s=l("el-button"),i=l("t-adaptive-page");return n(),o(i,{title:"操作日志列表",isCopy:"",table:c(y).table,columns:c(y).table.columns,isTTableSelfFilling:"",onSelectionChange:v,onSizeChange:k,onPageChange:S,opts:c(g),onSubmit:h},{toolbar:r((()=>[a(s,{type:"primary"},{default:r((()=>[p("清空")])),_:1}),a(s,{type:"danger",disabled:c(y).ids.length<1},{default:r((()=>[p("删除")])),_:1},8,["disabled"])])),_:1},8,["table","columns","opts"])}}});export{y as default};
