...
// 相关列表
listTypeInfo:{hobbyList:[{label:"吉他",value:"0"},{label:"看书",value:"1"},{label:"美剧",value:"2"},{label:"旅游",value:"3"},{label:"音乐",value:"4"}],sexList:[{key:"女",value:1},{key:"男",value:0}],statusList:[{key:"启用",value:1},{key:"停用",value:0}]}});return(e,o)=>{const r=t("t-form"),m=t("t-layout-page-item"),v=t("t-layout-page");return l(),a(v,null,{default:i((()=>[s(m,null,{default:i((()=>[s(r,{ref_key:"TFormDemo",ref:p,modelValue:u(n).ref,"onUpdate:modelValue":o[0]||(o[0]=e=>u(n).ref=e),formOpts:u(n)},null,8,["modelValue","formOpts"])])),_:1})])),_:1})}}}),[["__file","index.vue"]]);export{n as default};
