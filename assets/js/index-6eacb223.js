...
// 相关列表
listTypeInfo:{hobbyList:[{label:"吉他",value:"0"},{label:"看书",value:"1"},{label:"美剧",value:"2"},{label:"旅游",value:"3"},{label:"音乐",value:"4"}],sexList:[{key:"女",value:1},{key:"男",value:0}],statusList:[{key:"启用",value:1},{key:"停用",value:0}]}});return(e,u)=>{const r=t("el-radio-button"),v=t("el-radio-group"),c=t("t-form"),d=t("t-layout-page-item"),j=t("t-layout-page");return l(),a(j,null,{default:i((()=>[o(d,null,{default:i((()=>[o(v,{modelValue:p.value,"onUpdate:modelValue":u[0]||(u[0]=e=>p.value=e),size:"small",style:{"margin-bottom":"15px"}},{default:i((()=>[o(r,{value:1},{default:i((()=>[s("一行展示")])),_:1}),o(r,{value:2},{default:i((()=>[s("一行展示2项")])),_:1}),o(r,{value:3},{default:i((()=>[s("一行展示3项")])),_:1}),o(r,{value:4},{default:i((()=>[s("一行展示4项")])),_:1})])),_:1},8,["modelValue"]),o(c,{ref_key:"TFormDemo",ref:n,modelValue:m.ref,"onUpdate:modelValue":u[1]||(u[1]=e=>m.ref=e),formOpts:m,widthSize:p.value},null,8,["modelValue","formOpts","widthSize"])])),_:1})])),_:1})}}}),[["__file","index.vue"]]);export{n as default};
