...
// 相关列表
listTypeInfo:{sexList:[{key:"女",value:1},{key:"男",value:0}],accountTypeList:{0:"手机用户",1:"论坛用户",2:"平台用户"},statusList:[{key:"启用",value:1},{key:"停用",value:0}]}}}});return(e,o)=>{const u=t("t-table"),c=t("t-module-form"),d=t("t-layout-page-item"),v=t("t-layout-page");return l(),a(v,{class:"t_module_form_demo"},{default:i((()=>[s(d,{isNoMargin:""},{default:i((()=>[s(c,{title:"模块插槽使用",subTitle:"模块插槽使用副标题",ref_key:"sourceForm",ref:r,formOpts:m,submit:p},{lineMessage:i((()=>[s(u,{title:"模块插槽使用",table:n,columns:n.columns,isCopy:""},null,8,["table","columns"])])),_:1},8,["formOpts"])])),_:1})])),_:1})}}}),[["__file","slotName.vue"]]);export{p as default};
