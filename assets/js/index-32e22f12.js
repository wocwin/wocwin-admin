import{w as e}from"./@element-plus_icons-vue@2.1.0_vue@3.2.47-9404aa47.js";import i from"./TIcon-bf8c624a.js";import{u as t}from"./useApi-9a108d42.js";import{c as l,_ as a}from"./index-4c23e259.js";import{E as o,b as s}from"./element-plus@2.7.8_vue@3.2.47-dd3ca4aa.js";import{d as n,c as r,J as u,$ as p,v as m,f as d,E as c,o as v,Q as f,R as h,D as b,b as y,y as j}from"./@vue_runtime-core@3.2.47-93afb68a.js";import{r as g,a as _,x as w,u as L,i as k}from"./@vue_reactivity@3.2.47-d6eb3395.js";import"./@vue_shared@3.2.47-177e1703.js";import"./@vue_runtime-dom@3.2.47-8b00e8ad.js";import"./pinia@2.0.33_typescript@5.0.4_vue@3.2.47-2fb95ed1.js";import"./vue-demi@0.14.0_vue@3.2.47-71ba0ef2.js";import"./@vue_devtools-api@6.5.0-d955f204.js";import"./lodash-es@4.17.21-dc611046.js";import"./@vueuse_shared@9.13.0_vue@3.2.47-e2e5fabe.js";import"./@vueuse_core@9.13.0_vue@3.2.47-f67a1fb8.js";import"./@element-plus_icons-vue@2.3.1_vue@3.2.47-228618a4.js";import"./@sxzz_popperjs-es@2.11.7-b78c3215.js";import"./@ctrl_tinycolor@3.6.0-142ab585.js";import"./dayjs@1.11.7-241834cb.js";import"./@intlify_core-base@9.2.2-0528b302.js";import"./@intlify_message-compiler@9.2.2-e2e032fa.js";import"./@intlify_shared@9.2.2-eb5ba5c2.js";import"./source-map@0.6.1-f5811eb2.js";import"./@intlify_devtools-if@9.2.2-c4c7726f.js";import"./async-validator@4.2.5-cf877c1f.js";import"./memoize-one@6.0.0-63ab667a.js";import"./normalize-wheel-es@1.2.0-3222b0a2.js";import"./@floating-ui_dom@1.2.7-0180cacd.js";import"./@floating-ui_core@1.2.6-eb72d81f.js";import"./vue-router@4.1.6_vue@3.2.47-56c8912c.js";import"./js-cookie@3.0.1-d59fc71c.js";import"./axios@1.3.4-e3d92af1.js";import"./vite-plugin-qiankun@1.0.15_typescript@5.0.4_vite@4.3.9-f25e2b71.js";import"./nprogress@0.2.0-0d47f636.js";import"./ant-design-vue@4.2.5_vue@3.2.47-d72fa1cb.js";import"./resize-observer-polyfill@1.5.1-3b32e109.js";import"./@babel_runtime@7.21.5-f3180b7b.js";import"./@ant-design_icons-vue@7.0.1_vue@3.2.47-728896b1.js";import"./@ant-design_icons-svg@4.3.0-242d2267.js";import"./@ant-design_colors@6.0.0-6d00c5a2.js";import"./throttle-debounce@5.0.2-ba017292.js";import"./vue-types@3.0.2_vue@3.2.47-6bcea8eb.js";import"./@emotion_hash@0.9.2-32e4a972.js";import"./@emotion_unitless@0.8.1-6ad1c55b.js";import"./stylis@4.3.4-cd94ce99.js";import"./dom-align@1.12.4-430184c7.js";import"./vue-marquee-text-component@2.0.1-fc18f8c0.js";import"./vue@3.2.47-22c49a62.js";import"./vue-i18n@9.2.2_vue@3.2.47-3a58c2b9.js";import"./pinia-plugin-persistedstate@3.1.0_pinia@2.0.33-d2bd58cf.js";import"./echarts@5.4.2-f2ea7978.js";import"./tslib@2.3.0-a4e99503.js";import"./zrender@5.4.3-b1e59f6a.js";import"./@wocwin_t-ui-plus@1.4.13-7c84392f.js";const x={class:"dialog-footer"};const S=a(n({...n({name:"menuMange"}),setup(a){const n=l().authButtonListGet,{proxy:S}=t(),I=g("新增菜单"),H=g(!1),T=g([]),C=_({ref:null,formData:{parentId:0,
// 上级菜单
menuType:"M",
// 菜单类型
title:null,
...
component:null,
// 组件路径
remark:null},null==(e=C.ref)||e.resetFields()},F=_({queryData:{title:null,
// 菜单名称
path:null}}),E=_({data:[],columns:[{label:"菜单名称",render:(e,i)=>r("div",null,[i.meta.title]),minWidth:180},{label:"菜单图标",render:(e,t)=>r(i,{icon:t.meta.icon},null),minWidth:80},{prop:"menuType",label:"菜单类型",minWidth:120,render:e=>{const{type:i,val:t}={M:{type:"info",val:"目录"},C:{type:"success",val:"菜单"},F:{type:"warning",val:"按钮"}}[e]||{};return r(p("el-tag"),{type:i},"function"==typeof(l=t)||"[object Object]"===Object.prototype.toString.call(l)&&!j(l)?t:{default:()=>[t]});var l}},{prop:"name",label:"菜单 name",minWidth:180},{prop:"path",label:"菜单路径",minWidth:180},{prop:"component",label:"组件路径",minWidth:180}],operator:[{text:"新增",fun:e=>{H.value=!0,I.value="新增菜单",q(),C.fieldList.forEach((e=>{const i="C"===C.formData.menuType||C.formData.isShowLink;"component"!==e.value&&"isLink"!==e.value||(e.isHideItem=!i)})),C.formData.parentId=e.parentId},hasPermi:"root:web:sys:menu:add"},{text:"编辑",fun:e=>{H.value=!0,I.value="编辑菜单";const{parentId:i,menuType:t,label:l,orderNum:a,isShowLink:o,path:s,component:n,remark:r,meta:u}=e,{fieldList:p}=C;p.forEach((e=>{const i="component"===e.value&&"C"===t||"isLink"===e.value&&o;"component"!==e.value&&"isLink"!==e.value||(e.isHideItem=!i)})),C.formData={parentId:i,menuType:t,title:l,orderNum:a,isShowLink:o,icon:u.icon,isFull:u.isFull,isHide:u.isHide,isAffix:u.isAffix,isKeepAlive:u.isKeepAlive,isLink:u.isLink,activeMenu:u.activeMenu,path:s,component:n,remark:r}},hasPermi:"root:web:sys:menu:alter"},{text:"删除",fun:e=>{s.confirm("此操作将永久删除该文件, 是否继续?","提示",{confirmButtonText:"确定",cancelButtonText:"取消",type:"warning"}).then((()=>{o.success({message:"删除成功!"})})).catch((()=>{o.info({message:"已取消删除"})}))},hasPermi:"root:web:sys:menu:del"}],
// 操作列样式
operatorConfig:{fixed:"right",
// 固定列表右边（left则固定在左边）
align:"left",width:"160",label:"操作"}}),N=m((()=>({title:{label:"菜单名称",comp:"el-input"},path:{label:"菜单路径",comp:"el-input"}}))),P=(m((()=>{const{title:e,path:i}=w(F.queryData);return{title:e.value,path:i.value}})),e=>{F.queryData=e,K()});d((()=>{K()}));const K=async()=>{const e=await S.$api.getRouters();if(e.success){E.data=e.data;let i=[];const t={parentId:0,menuId:0,orderNum:0,menuType:"M",path:"",component:"",name:"",meta:{title:"主类目",isHide:!1,isFull:!1,isAffix:!1,isKeepAlive:!1},children:[]};t.children=e.data,i.push(t);const l=await R(i);T.value=l,C.fieldList[0].bind.options=T.value}},R=e=>(e.forEach((e=>{e.label=e.meta.title,e.value=e.menuId,e.children&&R(e.children)})),e);return(e,i)=>{const t=p("el-button"),l=p("t-form"),a=p("el-dialog"),o=p("t-adaptive-page"),s=c("hasPermi");return v(),f(o,{class:"menu_mange",title:"菜单管理页面","row-key":"path",isTree:"",align:"left",btnPermissions:L(n),table:L(E),"tree-props":{children:"children",hasChildren:"hasChildren"},columns:L(E).columns,isShowPagination:!1,opts:L(N),onSubmit:P,height:"100%"},{toolbar:h((()=>[b((v(),f(t,{type:"primary",onClick:M},{default:h((()=>[u("新增菜单")])),_:1})),[[s,"root:web:sys:menu:add"]])])),default:h((()=>[r(a,{title:L(I),width:"70%",draggable:"",modelValue:L(H),"onUpdate:modelValue":i[2]||(i[2]=e=>k(H)?H.value=e:null)},{footer:h((()=>[y("div",x,[r(t,{onClick:i[1]||(i[1]=e=>H.value=!1)},{default:h((()=>[u("取消")])),_:1}),r(t,{type:"primary",onClick:D},{default:h((()=>[u("确定")])),_:1})])])),default:h((()=>[r(l,{modelValue:L(C).ref,"onUpdate:modelValue":i[0]||(i[0]=e=>L(C).ref=e),formOpts:L(C),widthSize:2,onHandleEvent:A},null,8,["modelValue","formOpts"])])),_:1},8,["title","modelValue"])])),_:1},8,["btnPermissions","table","columns","opts"])}}}),[["__file","index.vue"]]);export{S as default};
