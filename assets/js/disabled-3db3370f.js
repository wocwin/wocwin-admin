import{e,c as l,J as a,_ as t,o as u,P as n,Q as o}from"./@vue_runtime-core@3.2.47-c6dbaf88.js";import{r as i,j as p}from"./@vue_reactivity@3.2.47-57d9983b.js";import"./@vue_shared@3.2.47-177e1703.js";const r=e({__name:"disabled",setup(e){const r=i(null),s=e=>{},c=p({goodsInformation:{title:"禁止收缩",name:"goodsInformation",disabled:!0,ref:null,opts:{formData:{id:`${Math.floor(10*Math.random()+1)}`,
// *唯一ID
account:null,
// *用户账号
password:null,
...
// 相关列表
listTypeInfo:{sexList:[{key:"女",value:1},{key:"男",value:0}],accountTypeList:{0:"手机用户",1:"论坛用户",2:"平台用户"},statusList:[{key:"启用",value:1},{key:"停用",value:0}]}}}});return(e,a)=>{const i=t("t-module-form"),p=t("t-layout-page-item"),m=t("t-layout-page");return u(),n(m,{class:"t_module_form_demo"},{default:o((()=>[l(p,{isNoMargin:""},{default:o((()=>[l(i,{title:"模块表单组件运用",subTitle:"模块表单222",ref_key:"sourceForm",ref:r,formOpts:c,submit:s},null,8,["formOpts"])])),_:1})])),_:1})}}});export{r as default};
