...
// 相关列表
listTypeInfo:{sexList:[{key:"女",value:1},{key:"男",value:0}],accountTypeList:{0:"手机用户",1:"论坛用户",2:"平台用户"},statusList:[{key:"启用",value:1},{key:"停用",value:0}]}}}});return(e,s)=>{const r=t("t-module-form"),c=t("t-layout-page-item"),v=t("t-layout-page");return l(),a(v,{class:"t_module_form_demo"},{default:i((()=>[o(c,{isNoMargin:""},{default:i((()=>[o(r,{title:"自定义返回事件",ref_key:"sourceForm",ref:u,formOpts:m,isGoBackEvent:"",submit:p,onBack:n},null,8,["formOpts"])])),_:1})])),_:1})}}}),[["__file","isGoBackEvent.vue"]]);export{p as default};
