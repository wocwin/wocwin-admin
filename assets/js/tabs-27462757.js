...
// 相关列表
listTypeInfo:{sexList:[{key:"女",value:1},{key:"男",value:0}],accountTypeList:{0:"手机用户",1:"论坛用户",2:"平台用户"},statusList:[{key:"启用",value:1},{key:"停用",value:0}]}}}});return(e,t)=>{const p=l("t-table"),n=l("t-module-form"),j=l("t-layout-page-item"),_=l("t-layout-page");return a(),s(_,{class:"t_module_form_demo"},{default:i((()=>[o(j,{isNoMargin:""},{default:i((()=>[o(n,{title:"显示tabs且默认显示tab2",ref_key:"sourceForm",ref:r,formOpts:y,submit:m,tabs:b.value,isTabMargin:"",onTabsChange:d},{tab1:i((()=>[u("基础信息")])),tab2:i((()=>[o(p,{title:"默认显示tab2",table:v,columns:v.columns,isCopy:""},null,8,["table","columns"])])),tab3:i((()=>[c])),_:1},8,["formOpts","tabs"])])),_:1})])),_:1})}}}),[["__file","tabs.vue"]]);export{d as default};
