    ...
    <t-layout-page-item>
      ...
      >
        <template #toolbar>
          ...
          <el-button type="primary" v-if="table.data.length > 0" @click="clearValidate">清除校验规则</el-button>
          <el-tooltip
...
// 添加数据条数
const num = ref(10);
const singleEditRules = ref<any>(null);
const tableData = ref([]);
...
// 编辑单元格监听事件
const handleEvent = (type: string, val: any, index: number) => {
